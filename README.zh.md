...
一款面向个人和小团队的 AI 影视创作工具。AI 全流程的短剧制作工具，支持从小说文本自动生成分镜、角色、场景，并制作成完整视频。
...
PopIdea 将客户端和服务端合二为一，集成在单个可执行文件中：
...
从 [发布页面](https://github.com/your-username/popidea/releases) 下载最新版本。
...
### 数据库
- 位置: `<app-data>/popidea/database.sqlite`
- 启动时自动迁移
- 架构变更前自动备份

### 存储
- 位置: `<app-data>/popidea/storage/`
- S3 兼容 API
- 自动清理未使用的资源
...
如有问题、疑问或建议，请在 [GitHub Issues](https://github.com/your-username/popidea/issues) 上提交 issue。
